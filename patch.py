...
assert 'AnalyticsView' not in src, 'Already patched - run: git checkout -- src/App.jsx'
print('Clean:', len(src))
...
i = src.index(anchor)
src = src[:i] + AV + '\n' + src[i:]
print('Component inserted, anchor found at', i)
